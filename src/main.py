...
def main() -> None:
    ...
    parser.add_argument("--max-papers", type=int, default=8, help="Max total papers to retrieve (default: 8)")
    parser.add_argument("--max-queries", type=int, default=4, help="Max search queries to generate (default: 4)")
